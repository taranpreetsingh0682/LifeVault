...
<main class="documents-container profile-page-container">
  ...
  <div class="documents-header mb-4">
    <div class="doc-title-area">
      <h1 class="doc-title">Account Profile</h1>
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <div class="profile-meta-hero">
          <div class="d-flex align-items-center gap-2 flex-wrap">
            <h2 class="profile-user-name mb-0">Taranpreet Singh</h2>
            <span class="badge bg-warning text-dark px-2.5 py-1 fw-bold rounded-pill">
              <i class="bi bi-star-fill me-1"></i> Premium Plan
            </span>
          </div>
          <p class="profile-user-email text-muted mb-1">taranpreet@example.com</p>
          <span class="text-xs text-muted">Member since January 2024 &bull; Verified Account</span>
        </div>
      </div>
