...
$starred_total = isset($starred_total) ? (int) $starred_total : $starred_files;
$identity_count = isset($identity_count) ? (int) $identity_count : $identity_docs;
$last_starred_at = isset($last_starred_at) ? $last_starred_at : null;

$important_category_counts = isset($important_category_counts)
    ? $important_category_counts
    : array();

$identity_starred = isset($important_category_counts['identity'])
    ? (int) $important_category_counts['identity']
    : 0;

$education_starred = isset($important_category_counts['education'])
    ? (int) $important_category_counts['education']
    : 0;

$personal_starred = isset($important_category_counts['personal'])
    ? (int) $important_category_counts['personal']
    : 0;

$financial_starred = isset($important_category_counts['financial'])
    ? (int) $important_category_counts['financial']
    : 0;

/*
 * Convert the latest starred timestamp into a friendly label.
 */
    ...
    <div class="documents-header">
        ...
        <div class="doc-title-area">
            ...
            <p class="doc-subtitle">
                Quick access to your starred, pinned, and high-priority vault records.
            </p>
            ...
            <div class="important-stat-card">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="imp-stat-label">
                            Starred Files
                        </span>

                        <h3 class="imp-stat-val mb-0">
                            <?= $starred_total; ?>
                        </h3>
            ...
            <div class="important-stat-card">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h3 class="imp-stat-val mb-0">
                            <?= html_escape($last_starred_label); ?>
                        </h3>
    ...
    <div class="filter-toolbar">
        ...
        <div class="filter-pills-group" id="importantPillsGroup">
            ...
            <button
                ...
                data-category="All">
                All Starred (<?= $starred_total; ?>)
            </button>

            <button
                class="filter-pill"
                data-category="Identity">
                Identity (<?= $identity_starred; ?>)
            </button>

            <button
                class="filter-pill"
                data-category="Education">
                Education (<?= $education_starred; ?>)
            </button>

            <button
                class="filter-pill"
                data-category="Personal">
                Personal (<?= $personal_starred; ?>)
            </button>

            <button
                class="filter-pill"
                data-category="Financial">
                Financial (<?= $financial_starred; ?>)
            </button>
                ...
                <tbody id="importantTableBody">
                    ...
                    <?php if (!empty($documents)): ?>
                        ...
                        <?php foreach ($documents as $document): ?>
                            ...
                            $document_category =
                                ucfirst(strtolower($document->category));
                            ...
                            <tr
                                data-category="<?= html_escape($document_category); ?>">

                                <td>

                                    <div class="d-flex align-items-center gap-2">

                                        <span class="badge-file-type badge-type-pdf">
                                            FILE
                                        </span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const buttons =
        document.querySelectorAll(
            '#importantPillsGroup .filter-pill'
        );

    const tableBody =
        document.getElementById('importantTableBody');

    const sortSelect =
        document.getElementById('impSortSelect');
